			...
			<div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
				...
				<nav class="nav-primary hidden-xs">
					<ul class="nav">
						...
						<li <?php if(strpos($_SERVER[REQUEST_URI],'jenis_pohon') !== false || strpos($_SERVER[REQUEST_URI],'point') !== false || strpos($_SERVER[REQUEST_URI],'bulk_import') !== false) echo "class='active'"?>>
							<a href="#"  >
